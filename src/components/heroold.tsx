...
function Hero() {
  return (
    <section className="relative w-full h-screen overflow-hidden p-12">
      ...
      <div className="absolute top-12 right-20 z-30">
        <Star className="text-white w-20 h-20 md:w-24 md:h-24 lg:w-28 lg:h-28" size={128} />
      </div>


      {/* Colonne verticale : Florian LEVREAU → PORTFOLIO → 3D Artist */}
      <div className=" top-12 z-30 flex flex-col gap-8">
        {/* 1. Florian LEVREAU */}
        ...
        {/* 2. PORTFOLIO */}
        <div className="pointer-events-none z-0 overflow-visible ">
          <h2 className="font-russo text-white uppercase tracking-tight leading-none select-none whitespace-nowrap scale-y-150" style={{ fontSize: 'clamp(8rem, 20vw, 25rem)', width: '100%' }}>
            Portfolio
          </h2>
        </div>
